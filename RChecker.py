...
def check_arguments():
    ...
    parser.add_argument("--timeout", help="Server ping timeout (default is 2)", default=2, dest="timeout",
                        action="store")
    parser.add_argument("--no-output", help="Prevents RChecker from saving the results to a text file", default=False,
                        dest="logs_file", action="store_true")
